(function (app, window) {
    ...
    app.generateScript = function () {
        ...
        var scriptTemplate = "(function (w) { var s = document.createElement('script'); s.src = 'https://rawgithub.com/JS2014TeamDaegon/FireworksJS/master/FireworksJS/js/fireworks-js/release/fireworks-js.min.js'; s.onload = function () { setTimeout(window.Fireworks.init(optionsPlaceHolder)); }; w.document.head.appendChild(s); })(window);";
        var options = "{";
